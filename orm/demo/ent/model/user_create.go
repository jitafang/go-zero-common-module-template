...
func (uc *UserCreate) SetStatus(es enum_status.Status) *UserCreate {
	uc.mutation.SetStatus(es)
	return uc
}

// SetVersion sets the "version" field.
func (uc *UserCreate) SetVersion(i int32) *UserCreate {
	uc.mutation.SetVersion(i)
	return uc
}

// SetNillableVersion sets the "version" field if the given value is not nil.
func (uc *UserCreate) SetNillableVersion(i *int32) *UserCreate {
	if i != nil {
		uc.SetVersion(*i)
	}
	return uc
...
func (uc *UserCreate) check() error {
	...
	if _, ok := uc.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`model: missing required field "User.status"`)}
	}
	if _, ok := uc.mutation.Version(); !ok {
		return &ValidationError{Name: "version", err: errors.New(`model: missing required field "User.version"`)}
	}
